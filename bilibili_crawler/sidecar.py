...
from bilibili_crawler.service.credentials import LLMCredentials, scrub
from bilibili_crawler.service.models import DESKTOP_POLICY, EventKind, RunStatus, TaskEvent
from bilibili_crawler.service.paths import analysis_assets_root, configure_matplotlib_cache
from bilibili_crawler.utils.helpers import ContentType, extract_uid, parse_input
...
class Sidecar:
    def __init__(self, services: SidecarServices | None = None) -> None:
        ...
        self._agent_analysis_cancel = threading.Event()
    ...
    def _start_task(
        ...
        with self._task_lock:
            ...
            if name == "comments":
                ...
                # The migrated comment-analysis path has the same handoff
                # window. Legacy analysis ignores this separate pending bit.
                self._agent_analysis_cancel.clear()
    ...
    def _stop_task(self) -> None:
        ...
        if active_mode == "analysis":
            ...
            self._agent_analysis_cancel.set()
