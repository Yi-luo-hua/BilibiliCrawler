...
from src.service.credentials import LLMProfile, resolve_llm_profile, scrub
from src.service.models import ServiceError
from src.service.paths import RUNS_DIR_ENV, RUNS_DIR_NAME, candidate_bases
...
def diagnose(*, check_provider: bool = False, timeout: float = 10.0) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "mcp": {"installed": version is not None, "version": version,
                "note": "MCP 服务需要 requirements-agent.txt；普通 CLI 和本诊断不要求安装 SDK。"},
